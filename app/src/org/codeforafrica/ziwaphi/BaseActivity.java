...
import org.codeforafrica.ziwaphi.facebook.UpdateActivity;
...
//		EasyTracker.getInstance(this).activityStop(this);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
        ...
        {	
            ...
            dialog_about.setTitle("About " + AppConstants.TAG);
            ...
            dialog_about.findViewById(R.id.imageView3).setOnClickListener(new View.OnClickListener(){
				...
				@Override
				public void onClick(View v) {
					openURL(DefaultsActivity.patner_site_url);
				}
            ...
            dialog_about.findViewById(R.id.rlWebsite).setOnClickListener(new View.OnClickListener(){
				...
				@Override
				public void onClick(View v) {
					openURL(DefaultsActivity.site_url);
				}
